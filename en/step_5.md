...
- Use RJ11 breakout boards - these can be really helpful for prototyping but the larger ones can be too bulky for long term deployment. Smaller ones often come with solderable pins that can be used with stripboard to make a durable board. 
